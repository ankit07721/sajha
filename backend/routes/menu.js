...
router.post('/', authenticateToken, authorizeRole('admin','chef'), [
...
router.put('/:id', authenticateToken, authorizeRole('admin','chef'), async (req, res) => {
  try {
...
router.delete('/:id', authenticateToken, authorizeRole('admin','chef'), async (req, res) => {
  try {
...
router.patch('/:id/availability', authenticateToken, authorizeRole('admin','chef'), async (req, res) => {
  try {
